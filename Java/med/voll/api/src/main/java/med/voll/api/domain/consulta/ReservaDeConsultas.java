...
public class ReservaDeConsultas {
    ...
    @Autowired
    private List<ValidadorCancelamientoDeConsulta> validadorCancelamientoConsultas;
    ...
    public DatosDetalleConsulta reservar(DatosReservaConsulta datos){
        ...
        if(medico == null){
            throw new ValidacionException("No existe un medico disponible");
        }
    ...
    private Medico elegirMedico(DatosReservaConsulta datos) {
        ...
        if(datos.especialidad() == null){
            throw new ValidacionException("Es necesarios elegir una especialidad cuando no se elige un médico");
        }
    ...
    public void cancelar(DatosCancelamientoConsulta datos) {
        ...
        validadorCancelamientoConsultas.forEach(v -> v.validar(datos));
