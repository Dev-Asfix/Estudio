...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deberia devolver metodo Http 400 cuadno la request no tenga datos")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deberia devolver metodo Http 200 cuando reciba un json valido")
    @WithMockUser
    ...
    void reservar_escenario2() throws Exception {
        ...
        var response = mockMvc.perform(post("/consultas")
                        ...
                        .content(datosReservaConsultaJson.write(
                                new DatosReservaConsulta(null,2l,5l,fecha,especialidad)
                        ).getJson())
                )
                .andReturn().getResponse();
